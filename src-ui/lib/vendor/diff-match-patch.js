...
const diffMatchPatchGlobal = typeof globalThis !== "undefined" ? globalThis : undefined;
if (diffMatchPatchGlobal) {
  /** @suppress {globalThis} */
  diffMatchPatchGlobal['diff_match_patch'] = diff_match_patch;
  /** @suppress {globalThis} */
  diffMatchPatchGlobal['DIFF_DELETE'] = DIFF_DELETE;
  /** @suppress {globalThis} */
  diffMatchPatchGlobal['DIFF_INSERT'] = DIFF_INSERT;
  /** @suppress {globalThis} */
  diffMatchPatchGlobal['DIFF_EQUAL'] = DIFF_EQUAL;
}
