...
const LUCIDE_SQUARE_ARROW_RIGHT_EXIT_ICON = `
  <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
    <path d="M10 12h11" />
              ...
              (chapter) => {
                ...
                <div class="chapter-table__row chapter-table__row--file">
                  ...
                  <div class="chapter-table__actions">
                    ...
                    ${canManageProjects ? iconAction("Delete", `delete-file:${chapter.id}`, LUCIDE_TRASH_2_ICON, {
                      disabled: offlineMode || lifecycleActionsDisabled || disableContentActions,
                      tooltip: "Delete",
                    }) : ""}
                  </div>
