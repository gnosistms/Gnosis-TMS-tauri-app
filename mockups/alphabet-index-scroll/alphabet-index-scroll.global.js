(function attachAlphabetIndexScroll(global) {
  "use strict";
  ...
  function normalizeIndexKey(value, options = {}) {
  ...
  function collectIndexSections(items, options = {}) {
    const alphabet = asArray(options.alphabet).length > 0
      ? options.alphabet.map((letter) => String(letter).toUpperCase())
      : DEFAULT_ALPHABET;
  ...
  function selectIndexKeys(sections, options = {}) {
  ...
  function createAlphabetIndexScroll(config) {
  ...
  global.AlphabetIndexScroll = Object.freeze({
