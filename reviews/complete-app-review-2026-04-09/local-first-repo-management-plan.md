...
- remaining gap: permanent-delete side effects around page-sync/debug/reload handling and some secondary lifecycle paths are still duplicated and need to be folded into the same shared adapter-driven engine
